YT: https://youtu.be/mCLYcsJ0GXQ

GH:  https://github.com/iam-veeramalla/aws-devops-zero-to-hero/tree/main/day-2

IAM

AWS IAM (Identity and Access Management):
is a service provided by Amazon Web Services (AWS) that helps you manage access to your AWS resources. It's like a security system for your AWS account.
